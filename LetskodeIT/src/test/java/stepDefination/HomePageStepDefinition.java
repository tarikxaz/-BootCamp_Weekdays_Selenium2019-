...
public class HomePageStepDefinition extends TestHomePage {
    ...
    private void clickSelectClassBar() {
    }
    ...
    private void selectFromDrop(String webElemetSelectButton, String benz) {
    }
    ...
    private void scrollToWebElement(String webElemetIframeName) {
    }
    @Given("I search PNT")
