...
public class WebAPI {
    ...
    public String browserstack_username = "tarikaziz4";
    public String browserstack_accesskey = "FpqhC7rq8RJ2Yq7ejzj1";
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\tanz9\\IdeaProjects\\BootCamp_Weekdays_Selenium_December2019\\LetskodeIT\\BrowserDriver\\chromedriver.exe");
            }
            ...
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\tanz9\\IdeaProjects\\BootCamp_Weekdays_Selenium_December2019\\LetskodeIT\\BrowserDriver\\chromedriver.exe");
            }
